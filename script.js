...
if (start_input.toLowerCase() === "quit"){
    ...
    while (mistakes < 7 && counter > 0){
        
        //requesting user input and transf. to lowercase
        let word_inp = prompt("Type a letter: ");
        ...
        console.log((hangman.join("")).toUpperCase());    
        } else {
    ...
    console.log("Please type Start / Quit");
}
